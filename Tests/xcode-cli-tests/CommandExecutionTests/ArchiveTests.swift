...
struct ArchiveTests {
    ...
    @Test(
        ...
        arguments: [
            (
                projectPath: "MyApp.xcodeproj" as String?,
                workspacePath: nil as String?,
                scheme: "MyScheme",
                config: "Release",
                archivePath: "./build/MyApp.xcarchive",
                signingStyle: "manual" as String?,
                identity: "Apple Distribution: My Company" as String?,
                teamID: "TEAM123" as String?,
                profileUUID: "profile-uuid-123" as String?,
                profileName: nil as String?,
                profilePath: nil as String?,
                derivedDataPath: nil as String?
            ),
            (
                projectPath: nil as String?,
                workspacePath: "MyApp.xcworkspace" as String?,
                scheme: "WorkspaceScheme",
                config: "AppStore",
                archivePath: "./archives/App.xcarchive",
                signingStyle: "automatic" as String?,
                identity: nil as String?,
                teamID: "AUTO123" as String?,
                profileUUID: nil as String?,
                profileName: nil as String?,
                profilePath: nil as String?,
                derivedDataPath: "./DerivedData" as String?
            ),
            (
                projectPath: "TestApp.xcodeproj" as String?,
                workspacePath: nil as String?,
                scheme: "TestScheme",
                config: "Release",
                archivePath: "./test.xcarchive",
                signingStyle: "manual" as String?,
                identity: "Apple Distribution" as String?,
                teamID: "TEST456" as String?,
                profileUUID: nil as String?,
                profileName: "MyApp Distribution Profile" as String?,
                profilePath: nil as String?,
                derivedDataPath: nil as String?
            ),
            (
                projectPath: "PathApp.xcodeproj" as String?,
                workspacePath: nil as String?,
                scheme: "PathScheme",
                config: "Release",
